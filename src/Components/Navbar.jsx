...
export default function Navbar() {
  ...
  return (
    <nav
      className={` dark:shadow-2xl shadow-lg shadow-gray-200 dark:shadow-lime-400 fixed w-full z-50 py-4 border-[1px] dark:border-stone-700 transition-all duration-500 px-6 flex justify-between  items-center bg-white dark:bg-black/90 text-white cursor-pointer ${
